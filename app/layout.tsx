    ...
    <html lang="en">
      <body className={`font-sans antialiased`}>
        <header className="mb-8">
          {/* Header */}
          <div className="text-center mb-8 text-left relative">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-2 tracking-tight">CHIP-8 EMULATOR</h1>
          </div>
          <a href="https://github.com/adityaamehra/chip8-emulation" target="_blank" className="github-corner" aria-label="View source on GitHub">
            <svg
              width="80"
              height="80"
              viewBox="0 0 250 250"
              style={{ fill: "#000", color: "#4fc660", position: "absolute", top: 0, border: 0, right: 0 }}
              aria-hidden="true"
            >
